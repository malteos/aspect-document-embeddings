...
#    for FOLD in "sample" 1 2 3 4
#    do
    OUTPUT_DIR=$ASPECT_DIR/$FOLD/st_${MODEL_NAME}_$LOSS
    echo $FOLD
    # train
    ...
    # evaluate
    ./eval_cli.py evaluate_vectors $HF_DATASET $ASPECT $OUTPUT_DIR/pwc_id2vec.w2v.txt --name=st_${MODEL_NAME}_$LOSS --folds=$FOLD --top_ks=$TOP_KS --output_path=$ASPECT_DIR/eval.csv
#    done
done
