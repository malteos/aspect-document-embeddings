...
from models.bart import BartForMultiLabelSequenceClassification
...
from models.longformer import LongformerForMultiLabelSequenceClassification
from models.roberta import RobertaForMultiLabelSequenceClassification
from models.xlnet import XLNetForMultiLabelSequenceClassification
...
class AutoModelForMultiLabelSequenceClassification:
    ...
    def from_config(cls, config):
        ...
        """
        for config_class, model_class in MODEL_FOR_MULTI_LABEL_SEQUENCE_CLASSIFICATION_MAPPING.items():
