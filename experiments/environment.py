...
#     'gpu_server': {
#         'test': os.path.exists('~'),
#         'data_dir': '~/datasets/acl-anthology',
#         'bio_data_dir': '~/notebooks/data/biodocsim',
#         'bert_dir': '~/datasets/BERT_pre_trained_models/pytorch',
#         'germeval_dir': '~/notebooks/bert-text-classification',
#         'workers': 12,
#     },
# }
